...
void node_write_task(void *arg)
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            if (com_rslt == SUCCESS)
            {
                // char v_uncomp_temperature;
                // sprintf(v_uncomp_temperature, "%2.13f", bme280_compensate_temperature_double(v_uncomp_temperature_s32));

                // char v_uncomp_pressure;
                // sprintf(v_uncomp_pressure, "%2.13f", bme280_compensate_pressure_double(v_uncomp_pressure_s32));

                // char v_uncomp_humidity;
                // sprintf(v_uncomp_humidity, "%2.13f", bme280_compensate_humidity_double(v_uncomp_humidity_s32));

                // size = sprintf(data, v_uncomp_temperature_s32, " ", v_uncomp_pressure_s32, " ", v_uncomp_humidity_s32, " 1");
                size = sprintf(data, "%.2f %.3f %.3f 1",
